...
def main_screen():
    ...
    Button(text="DECRYPT",height="2",width=15,bg="#00bd56",fg="black",bd=0,command=decrypt).place(x=200,y=250)
    Button(text="RESET",height="2",width=36,bg="#1089ff",fg="black",bd=0,command=reset).place(x=10,y=300)
